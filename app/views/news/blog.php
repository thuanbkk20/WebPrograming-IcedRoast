    ...
    <a style="text-decoration: none;color:black;" href="<?php echo $blog['link']; ?>"> 
        <div class="card shadow-sm h-100" style="border:none;">
          ...
          <div class="d-flex flex-column">
              <div class="bg-image hover-overlay ripple rounded-top mb-2" data-mdb-ripple-color="light">
                <img src="<?php echo $blog['image']; ?>" class="card-img-top" style="width: 100%; height: 300px;"/>
              </div>
              <!-- Title -->
