<h1 class="d-flex justify-content-between " style="margin-left: 700px;" >Chỉnh sửa tài khoản</h1>

<form class="p-4 border rounded mx-auto" method="post" action="<?php echo _WEB_ROOT.'/admin/UserModify/update';?>" style="width:42%; background-color: rgb(194, 241, 200);">
    <!-- form content -->
    ...
    <div class="d-flex justify-content-center">
        <button type="submit"
        class="btn btn-primary">Chỉnh sửa tài khoản</button>
    </div>
</form>
<br/><br/>