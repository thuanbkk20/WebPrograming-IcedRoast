    ...
    <div class="row gx-5">
      <div class="col-md-6 mb-4">
        <div class="bg-image hover-overlay ripple shadow-2-strong rounded-5" data-mdb-ripple-color="light">
          <img src="https://file.hstatic.net/1000075078/file/photo_2021-11-25_09-31-52_52c6f13fcc06433db2362281059d1c09.jpg" class="img-fluid" />
          <a href="#!">
    ...
    <div class="row gx-lg-5">
      <div class="col-lg-4 col-md-12 mb-4 mb-lg-0">
        ...
        <div>
          ...
          <div class="bg-image hover-overlay shadow-1-strong ripple rounded-5 mb-4"
            ...
            <img src="https://hrw.hstatic.net/200000000005/24/recruitment/1a160a4a24f641fea3bf63a0e2f984fb.jpg" class="img-fluid"  />
            <a href="#!">
              <div class="mask" style="background-color: rgba(251, 251, 251, 0.15);"></div>
            </a>
          </div>
      ...
      <div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
        ...
        <div>
          ...
          <div class="bg-image hover-overlay shadow-1-strong rounded-5 ripple mb-4"
            data-mdb-ripple-color="light">
            <img src="https://thehivevilla.com/wp-content/uploads/2019/02/Untitled-design-3.png" class="img-fluid"
              alt="Grand opening" />
            <a href="#!">
              <div class="mask" style="background-color: rgba(251, 251, 251, 0.15);"></div>
            </a>
      ...
      <div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
        ...
        <div>
          ...
          <div class="bg-image hover-overlay shadow-1-strong rounded-5 ripple mb-4"
            data-mdb-ripple-color="light">
            <img src="https://images.foody.vn/res/g31/307624/prof/s576x330/image-8b8f5980-221019091025.jpeg" class="img-fluid"
